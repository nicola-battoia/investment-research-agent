...
- OpenAI SDK against Azure AI Foundry's v1 endpoint for LLMs and embeddings
...
- Integration tests go behind `@pytest.mark.integration` and may require live Azure AI Foundry / Supabase credentials.
